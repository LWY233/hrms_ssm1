				...
				<div class="info">
					...
					<div class="info_bottom">
						<form action="${path}/${url}" method="post" id="forminfo">
							...
							<label>月份</label>
							<input type="text" name="month" placeholder="格式：2017-01" value="${rap.month}" />
				...
				<div class="info">
					...
					<div class="info_bottom">
							...
							<c:forEach items="${datas.data}" var="d">
									...
									<td><c:if test="${loginUser.userType <3 }"><a href="${path}/${urlmain}/update?id=${d.id}" style="color:red;"> 修改</a></c:if></td>
									</tr>
							</c:forEach>
							</table>
